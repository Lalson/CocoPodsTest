...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "lalson" => "lalson@hifx.co.in" }
  # Or just: spec.author    = "lalson"
  # spec.authors            = { "lalson" => "lalson@hifx.co.in" }
  # spec.social_media_url   = "https://twitter.com/lalson"
  ...
  spec.source       = { :git => "https://github.com/Lalson/CocoPodsTest.git", :tag => "0.0.1" , :commit => "a5c8a6384084f80a2e15cdc6d02a5d3494065599" }
